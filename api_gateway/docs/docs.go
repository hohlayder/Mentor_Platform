// Package docs Code generated by swaggo/swag at 2025-11-18 23:21:18.2447412 +0300 MSK m=+4.437645701. DO NOT EDIT
package docs
...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_hohlayder_Mentor_Platform_api_gateway_internal_domain.CreateUserRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/github_com_hohlayder_Mentor_Platform_api_gateway_internal_domain.CreateUserResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "github_com_hohlayder_Mentor_Platform_api_gateway_internal_domain.CreateUserRequest": {
            "type": "object",
            "required": [
                "email",
                "first_name",
        ...
        "github_com_hohlayder_Mentor_Platform_api_gateway_internal_domain.CreateUserResponse": {
            "type": "object",
            "properties": {
                "user_id": {
                    "type": "string"
